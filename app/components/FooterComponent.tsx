...
const FooterComponent = () => {
  return (
    <Container
      className="d-flex flex-lg-row flex-column justify-content-lg-between justify-content-center align-items-center px-5 py-5 bg-secondary font-inter gap-md-0 gap-5"
      data-aos="fade-up"
    >
      <div>
        <Link
